...
#kable(select(genre_counts, -age_certification), caption = "<b><center>Number of movies and TV shows by genre") %>% kable_styling(bootstrap_options = "bordered", full_width = FALSE)
...
### Which actors and directors are associated with the highiest-rated titles based on an average of IMDB and TMDB scores
