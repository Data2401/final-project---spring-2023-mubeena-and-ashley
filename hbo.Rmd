...
## Let's see some movie titles that are rated NC-17 but dealing with horror genres
...
age_titles %>% filter(genres == "horror" & (age_certification == "G" | age_certification == "TV-G"))
```
